...
public class SocketClient
{
    ...
    void WriteMessage(byte[] message)
    {
        ...
        using (ms = new MemoryStream())
        {
            ...
            {
                GD.Print("client.connected----->>false");
            }
        }
    }
    ...
    {
        ConnectServer(NetConfig.SocketAddress, NetConfig.SocketPort);
    }
